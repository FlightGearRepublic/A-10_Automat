...
var init_bombable_dialog = func () {
       ...
       if (bomb_menuNum==nil or bomb_menuNum==-1) {
        ...
        props.globals.getNode ("/sim/menubar/default/menu["~bomb_menuNum~"]/name", 1).setValue("Automat");
        ...
        props.globals.getNode ("/sim/menubar/default/menu["~bomb_menuNum~"]/item/label", 1).setValue("Automat Settings"); #must be unique name from all others in the menubar or they both pop up together
        ...
        props.globals.getNode ("/sim/menubar/default/menu["~bomb_menuNum~"]/item[1]/label", 1).setValue("Automat Statistics"); #must be unique name from all others in the menubar or they both pop up together
...
#################################################################
    create : func {
        ...
        titlebar.addChild("text").set("label", "Automat Settings");
...
records.show_totals_dialog = func {
       var totals= {
         title: "Automat Statistics Summary",
